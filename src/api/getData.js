...
export const login = data => fetch('/user/adminLogin', data, 'POST');
...
export const addShop = data => fetch('/user/addShop', data, 'POST');
...
export const updateResturant = data => fetch('/user/modifyShop', data, 'POST');
